<?php
	$filename='/files/pdf/'.$file.'.pdf';
	if(!file_exists(APP_DIR_PATH. '/public'.$filename))die();
?>
<!DOCTYPE html>
<!--
...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  <head>
	<base href="/css/pdf/" target="_blank">
    <meta charset="utf-8">
...
<!--#if !PRODUCTION-->
    <script type="text/javascript" src="web/ui_utils.js"></script>
    <script type="text/javascript" src="web/text_layer_builder.js"></script>
    <script type="text/javascript" src="web/pdf_find_bar.js"></script>
    <script type="text/javascript" src="web/pdf_find_controller.js"></script>
<!--#endif-->

    <script type="text/javascript" src="web/debugger.js"></script>
    <script type="text/javascript" src="web/viewer.js"></script>

  </head>

  <body tabindex="1">
	<input type="hidden" id="pdfpath" name="pdfpath" value="<?=$filename?>">
