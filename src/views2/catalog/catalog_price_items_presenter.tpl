	...
	<div class="search-result-content">
		...
		<div class="search-result-element-block">
			...
			<div class="element-info-block for-product">
				<a href="<?=$item['link']?>" class="element-name temp"><?=$item['name']?></a>
