<div class="popup wide">
	...
	<div class="inputs">
        ...
        <a class="btn-base btn-red" onclick="return confirm('Подтвердите удаление логотипа...')"  href="/firm-user/remove-logo/" rel="nofollow" style="text-transform: none;width: 142px;margin: 5px 0;">Удалить</a>
