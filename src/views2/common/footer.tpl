                                                ...
                                                <div class="soc_block">
                                                        <ul class="subscribe-list-social">
                                                                ...
                                                                <?$can_show=false;?>
                                                                        ...
                                                                        <?=($service->hasFBLink()  && $can_show) ? '<li><a target="_blank" href="' . $service->getFBLink() . '" class="fb" title="' . CHtml::encode($service->name()) . ' в Facebook" rel="nofollow"></a></li>' : ''?> 
                                                                        ...
                                                                        <?=($service->hasINLink() && $can_show) ? '<li><a target="_blank" href="' . $service->getINLink() . '" class="ig" title="' . CHtml::encode($service->name()) . ' в Instagram" rel="nofollow"></a></li>' : ''?> 
