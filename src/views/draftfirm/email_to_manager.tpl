<div style="background-color: #ffffff;" bgcolor="#ffffff">
	<p>На сайте TovaryPlus.ru изменилась информация об организации <strong>"<?=$item['company_name']?>"</strong>.</p>
	<p></p>
	...
	<p>Город: <?=$item['town']?> <br/>
	   Вид деятельности: <?=$item['business']?> <br/>
	   Сайт: <?=$item['company_web_site_url']?> 
	</p>
	<br/>
	<br/>
	<p>-------------------------------------------------------</p>
