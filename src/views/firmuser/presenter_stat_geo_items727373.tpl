...
<div class="attention-info">
	<div>Отчет "География" показывает, сколько за отчетный период посетителей и из каких регионов просматривали страницы сайта 727373.ru, где упоминалась информация о Вашей фирме. В отчет выводится 10 регионов с максимальным количеством посетителей. <br />
