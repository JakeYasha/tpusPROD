...
<div class="item_info">
    ...
    <div class="search_result">
        ...
        <div class="notice-dark-grey">
            <p>Есть вопросы? Позвони в техподдержку сайта: <span style="font-size: 21px;">+7&nbsp;(4852)&nbsp;42-97-82</span> или <a class="fancybox fancybox.ajax" href="/firm-feedback/get-feedback-form/38352/10/?id_option=18" rel="nofollow"><button style="width: 200px;"> Оставь сообщение </button></a></p>
        </div>
    </div>
</div>