...
<div class="attention-info" style="font-size: 0.85em;">
	<p>* Отчет "Статистика email, sms" показывает, сколько запросов было принято операторами справочной телефонной службы на формирование для абонента ответа с отправкой на его email или sms, 
