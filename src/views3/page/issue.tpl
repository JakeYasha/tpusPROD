...
<!-- Custom styles for this template -->
<link href="/css3/issuestyle.css" rel="stylesheet">
<!-- Custom styles for this template -->

<?
$data["HEADER_NAME"] = 'ВЕСЕННИЙ КАТАЛОГ';
$data["HEADER_DATE"] = ['21/02/2022','понедельник'];
        ...
        <div class="container">
            <header class="blog-header py-3">
                <div class="row align-items-center">
                    <div class="col-12 col-md-4 text-center text-md-left pt-1">
                        <a class="logo px-2" href="/"><img class="logo__img img-fluid" src="https://www.tovaryplus.ru/img3/logo.png"></a>
                    </div>
                    <div class="col-12 col-md-4 text-center">
                        <a class="blog-header-logo text-white nav-link" href="#"><?= $data["HEADER_NAME"] ?></a>
                    </div>
                    <div class="col-12 col-md-4 d-flex justify-content-center justify-content-md-end align-items-center">
                        <a class="link-secondary p-2 nav-link text-white text-center" href="#" aria-label="Search">
                            <?= $data["HEADER_DATE"][0] ?></br>
                            <small><?= $data["HEADER_DATE"][1] ?></small>
                        </a>
                    </div>
                </div>
            </header>
