<?= $bread_crumbs ?>
<a title="Выгрузить в xls" target="_blank" class="download-btn xls_s_file" href="<?= app()->link(app()->linkFilter('/firm-manager/statistics/', $filters, ['export' => 'xls'])) ?>"></a>
<a title="Выгрузить в pdf" target="_blank" class="download-btn pdf_s_file" href="<?= app()->link(app()->linkFilter('/firm-manager/statistics-pdf/', $filters)) ?>"></a>
<div class="black-block">Запросы</div>
<div class="search_result" style="border-top: none;">
    <div class="search_price_field">
        <form action="/firm-manager/statistics/" method="get">
