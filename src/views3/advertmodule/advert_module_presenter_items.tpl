							...
							<div class="hp_coupon_large_controls">
								<div class="for_client_tabs_button_set">
									...
									<? if ($advert_module->hasEmail() || $advert_module->hasPhone()) {?>
										<a class="btn btn_primary js-open-modal-ajax" rel="nofollow" target="_blank" href="#" data-target="requestForm" data-url="/advert-module/get-request-form/?id_advert_module=<?= $advert_module->id()?>" style="width: 90px;">
