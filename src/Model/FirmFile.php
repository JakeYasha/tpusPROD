...
class FirmFile extends \Sky4\Model\Composite {
	...
	public function fields() {
		return [
			'type' => [
				'col' => [
					'flags' => 'not_null',
					'type' => "list('image','file','promo-image')"
				],
				'elem' => 'radio_buttons',
				'label' => 'Вид данных',
				'options' => ['image' => 'Изображение', 'file' => 'Файл', 'promo-image' => 'Фото акции']
			],
			'flag_is_temp' => [
	...
	public function delete() {
		...
		$file2 = new \Sky4\FileSystem\File($this->embededFileComponent()->path('-330x200'));
		$file2 = new \Sky4\FileSystem\File($this->embededFileComponent()->path('-320x180'));
		$file3 = new \Sky4\FileSystem\File($this->embededFileComponent()->path('-160x160'));
		$file4 = new \Sky4\FileSystem\File($this->embededFileComponent()->path('-150x150'));
		$file5 = new \Sky4\FileSystem\File($this->embededFileComponent()->path('-120x90'));
		$file6 = new \Sky4\FileSystem\File($this->embededFileComponent()->path('-thumb'));
