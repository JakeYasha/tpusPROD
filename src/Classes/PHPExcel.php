...
use App\Classes\PHPExcel\PHPExcel_DocumentSecurity;
use App\Classes\PHPExcel\PHPExcel_Style;
use App\Classes\PHPExcel\PHPExcel_WorksheetIterator;
...
if (!defined('PHPEXCEL_ROOT')) {
	define('PHPEXCEL_ROOT', '/var/www/sites/tovaryplus.ru/protected/');
}
	...
	public function getRibbonBinObjects($What = 'all') {
		...
		switch ($What) {
			...
			case 'types':
				...
				} else $ReturnData = array(); //the caller want an array... not null if empty
				break;
		}
		return $ReturnData;
	}
