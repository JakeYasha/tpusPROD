...
use App\Classes\PHPExcel\CachedObjectStorage\PHPExcel_CachedObjectStorage_ICache;
...
class PHPExcel_CachedObjectStorageFactory
{
    ...
    public static function getCacheStorageMethods()
    {
        ...
        foreach(self::$_storageMethods as $storageMethod) {
            $cacheStorageClass = 'App\Classes\PHPExcel\CachedObjectStorage\PHPExcel_CachedObjectStorage_' . $storageMethod;
    ...
    public static function initialize($method = self::cache_in_memory, $arguments = array())
    {
        ...
        $cacheStorageClass = 'App\Classes\PHPExcel\CachedObjectStorage\PHPExcel_CachedObjectStorage_'.$method;
        ...
        if (self::$_cacheStorageMethod === NULL) {
            self::$_cacheStorageClass = 'App\Classes\PHPExcel\CachedObjectStorage\PHPExcel_CachedObjectStorage_' . $method;
